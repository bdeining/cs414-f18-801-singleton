...
public final class TableConstants {
  ...
  public static final String EXERCISE_TABLE_DEF =
      "(name varchar(100), id varchar(100), machineId varchar(100), sets integer, duration integer, workoutRoutineId varchar(100), branch varchar(100))";

  public static final String MACHINE_TABLE_DEF =
      "(name varchar(100), id varchar(100), picture varchar(65535), quantity integer, branch varchar(100))";

  public static final String EXERCISE_WORKOUT_ROUTINE_TABLE_DEF =
      "(workoutRoutineId varchar(100), exerciseId varchar(100), branch varchar(100))";

  public static final String CUSTOMER_WORKOUT_ROUTINE_TABLE_DEF =
      "(workoutRoutineId varchar(100), customerId varchar(100), branch varchar(100))";
  ...
  public static final String WORKOUT_ROUTINE_TABLE_DEF =
      "(id varchar(100), name varchar(100), branch varchar(100))";
